...
int main(){
   ...
   cout << endl << setw(58) << setfill('*') << "" << endl
      ...
      << setw(58) << "" << endl << setfill(' '); // sets blank spaces to empty
   ...
   // Final month's payments when payment > loan
   // Checks if loan is less than payment and not = 0 
   // to prevent unneccesary lines (in case above principle was perfect)
